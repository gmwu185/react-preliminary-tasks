...
function Tour() {
  ...
  useEffect(() => {
    ...
    if (tourDatas.length === 0) {
      ...
      */
      // fetch("https://thingproxy.freeboard.io/fetch/https://tour.klcg.gov.tw/data/attractions.json")
      //   .then((res) => res.json())
      //   .then( (data) => {
      //     console.log('thingproxy data', data)
      //   })
      //   .catch(err => console.log('thingproxy err', err))
      /* /cors proxy service use-3 */
